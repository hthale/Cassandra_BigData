...
# 📌 Lade die CSV-Datei
csv_file = "amazon_products.csv"  # Der Pfad zur CSV-Datei (wenn sie im gleichen Verzeichnis wie das Skript liegt)
...
print("\n📊 Erste 10 Einträge aus der Cassandra-Datenbank:")
